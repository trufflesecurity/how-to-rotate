    ...
    if(results.length && query_len >= required_query_len) {
      ...
      results.forEach(function(result){
        ...
        if(passive) {
          ...
          let description = result.body.substring(query_instance, query_instance + 200);
          let tempDoc = new DOMParser().parseFromString(description, "text/html");
          
          item_description.textContent = tempDoc.documentElement.textContent;
